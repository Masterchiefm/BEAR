...
class SangerBaseCall:
    ...
    def plotTarget(self, target_seq, plot_window=10):
        ...
        if sg_plot_start < sg_plot_end:
            ...
            SG = ax.plot([sg_plot_start - plot_start, sg_plot_end - plot_start], [-100, -100], color="brown",
                         label='sgRNA', marker=">")
            ...
            sg_plot_start = self.annotation[target_location[1]][1]
            SG = ax.plot([sg_plot_end - plot_start, sg_plot_start - plot_start - 9], [-100, -100], color="purple",
                         label='sgRNA', marker="<")
    ...
    def plotTargetHeatmap(self, data_sheet, base_of_interest=""):
        ...
        ax.set_title("Each base (ACGT) signal intensity at each position along " + "".join(list(data_sheet.loc["guide"])))
    ...
    def generateReport(self, target_seq, report_name, save_path ,plot_window=5, base_of_interest=""):
        ...
        content = [title, description, sep, sub_title_1, sanger_plot_md,Fig1_annotation, sep,sub_title_2, heatmap_plot_md,Fig2_annotation, sep, sub_title_3, sheet_annotation, sheet]
